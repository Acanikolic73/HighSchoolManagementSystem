    ...
    public partial class Class_Grade : Form
    {
        ...
        public Class_Grade(string t, string subject, string Class, string id)
        {
            ...
            for(int i = 0; i < numOfStudents; i++)
            {
                ...
                db2.query = "select g.value from Grade g join Enrollment e on g.student_id = e.student_id join Subject s on e.subject_id = s.subject_id where g.student_id = '" + ID + "' and s.subject_id = '" + id + "'";
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ModifingGrade f = new ModifingGrade(name, Student);
            f.Show();
        }
